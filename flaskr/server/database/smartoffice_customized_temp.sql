...
--
-- Dumping data for table `customized_temp`
--

LOCK TABLES `customized_temp` WRITE;
/*!40000 ALTER TABLE `customized_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `customized_temp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-20 12:30:36
