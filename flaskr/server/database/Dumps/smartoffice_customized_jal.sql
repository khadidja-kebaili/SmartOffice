...
--
-- Dumping data for table `customized_jal`
--

LOCK TABLES `customized_jal` WRITE;
/*!40000 ALTER TABLE `customized_jal` DISABLE KEYS */;
/*!40000 ALTER TABLE `customized_jal` ENABLE KEYS */;
UNLOCK TABLES;
