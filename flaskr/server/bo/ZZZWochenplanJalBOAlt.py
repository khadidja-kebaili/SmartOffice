...
class WeeklyPlanJalBO(Businessobject):
    ...
    def get_standard_weekly_plan(self):
        return self._standard
    ...
    def get_times_for_monday(self):
        times = self.get_time_for_a_weekday(1)
        return times

    def get_times_for_tuesday(self):
        times = self.get_time_for_a_weekday(2)
        return times

    def get_times_for_wednesday(self):
        times = self.get_time_for_a_weekday(3)
        return times

    def get_times_for_thursday(self):
        times = self.get_time_for_a_weekday(4)
        return times

    def get_times_for_friday(self):
        times = self.get_time_for_a_weekday(5)
        return times
