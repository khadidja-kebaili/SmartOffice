					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Office",
									"targetURL": "#comquantosolutionsuismartoffice-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"comquantosolutionsuismartoffice-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.quanto.solutions.ui.smartoffice",
									"url": sap.ui.require.toUrl("com/quanto/solutions/ui/smartoffice")
								}
							}
						}
					}
